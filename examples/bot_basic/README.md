...
> [!IMPORTANT]
> This is heavily based on [Fluxer.py Template](https://github.com/PerpetualPossum/fluxer-py-template), if you want a quick, easily clonable, ready-to-go setup, check that out!

## Features

- Basic bot object usage
- Bot events
- Bot commands
...
1. Copy the `bot_basic` folder somewhere in your computer
2. Get inside your `bot_basic` directory
3. Open a terminal (Command Prompt, Powershell, Bash, whatever) within your `bot_basic` directory
